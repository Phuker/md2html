...
> [李商隐](https://zh.wikipedia.org/zh-cn/%E6%9D%8E%E5%95%86%E9%9A%90 '维基百科：李商隐')
>
> 锦瑟[^jinse_1]无端[^jinse_2]五十弦[^jinse_3]，一弦一柱思华年。  
> 庄生晓梦迷蝴蝶[^jinse_4]，望帝春心托杜鹃[^jinse_5]。  
> 沧海月明珠有泪[^jinse_6]，蓝田[^jinse_7]日暖玉生烟。  
> 此情可待成追忆？只是[^jinse_8]当时已惘然。
...
一去二三里[^998]，烟村四五家。亭台六七座，八九十支花[^!@$*-_+=:;.]。The quick brown fox jumps over the lazy dog[^foo]. 一去二三里[^998]，烟村四五家。亭台六七座，八九十支花[^!@$*-_+=:;.]。The quick brown fox jumps over the lazy dog[^foo]. 一去二三里[^998]，烟村四五家。亭台六七座，八九十支花[^!@$*-_+=:;.]。The quick brown fox jumps over the lazy dog[^foo]. 一去二三里[^998]，烟村四五家。亭台六七座，八九十支花[^!@$*-_+=:;.]。The quick brown fox jumps over the lazy dog[^foo]. 一去二三里[^998]，烟村四五家。亭台六七座，八九十支花[^!@$*-_+=:;.]。The quick brown fox jumps over the lazy dog[^foo].
...
Test multi line footnote[^test_multi_line].
...
<!-- The second fundamental theorem of calculus, Newton–Leibniz axiom -->
```math
...
<!-- Maxwell's equations, reference: https://zhuanlan.zhihu.com/p/266061200 -->
```math
\left\{
\begin{align}
...
<!-- You can see me in the output -->

The next line is a markdown comment which starts with `<!---` and will be removed.

<!--- You can NOT see me in the output -->

Inline markdown comment, will be removed:<!--- You can NOT see me in the output either -->
